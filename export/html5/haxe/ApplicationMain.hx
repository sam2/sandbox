...
class ApplicationMain {
	...
	public static function main() {
		...
		//flash.Lib.setPackage("HaxeFlixel", "sandbox", "com.example.myapp", "0.0.1");
		...
		var urlLoader:URLLoader = new URLLoader();
		urlLoader.dataFormat = BINARY;
		urlLoaders.set("assets/images/actor1.json", urlLoader);
		total ++;
		...
		var urlLoader:URLLoader = new URLLoader();
		urlLoader.dataFormat = BINARY;
		urlLoaders.set("assets/images/actor2.json", urlLoader);
		total ++;
		...
		loaders.set("assets/images/actors.png", loader);
		total ++;
		...
		var loader:Loader = new Loader();
		loaders.set("assets/images/bg.jpg", loader);
		total ++;
		...
		var loader:Loader = new Loader();
		loaders.set("assets/images/panda.png", loader);
		total ++;
		...
		var urlLoader:URLLoader = new URLLoader();
		urlLoader.dataFormat = BINARY;
		urlLoaders.set("assets/images/skeleton.json", urlLoader);
		total ++;
		...
		var loader:Loader = new Loader();
		loaders.set("assets/images/skeleton.png", loader);
		total ++;
		...
		var loader:Loader = new Loader();
		loaders.set("assets/images/water.jpg", loader);
		total ++;
