...
class HXCPP_CLASS_ATTRIBUTES  FlxArrayUtil_obj : public hx::Object{
	...
	public:
		...
		static int indexOf_flixel_system_debug_WatchEntry( Array< ::Dynamic > array,::flixel::system::debug::WatchEntry whatToFind,hx::Null< int >  fromIndex);
		static Dynamic indexOf_flixel_system_debug_WatchEntry_dyn();
