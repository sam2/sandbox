...
{
		HX_STACK_PUSH("Sys::print","D:\\HaxeToolkit\\haxe/std/cpp/_std/Sys.hx",24);
		HX_STACK_ARG(v,"v");
		HX_STACK_LINE(24)
		::__hxcpp_print(v);
	}
...
{
		HX_STACK_PUSH("Sys::println","D:\\HaxeToolkit\\haxe/std/cpp/_std/Sys.hx",28);
		HX_STACK_ARG(v,"v");
		HX_STACK_LINE(29)
		::Sys_obj::print(v);
		HX_STACK_LINE(30)
...
::String Sys_obj::getCwd( ){
	HX_STACK_PUSH("Sys::getCwd","D:\\HaxeToolkit\\haxe/std/cpp/_std/Sys.hx",72);
	HX_STACK_LINE(72)
...
{
		HX_STACK_PUSH("Sys::setCwd","D:\\HaxeToolkit\\haxe/std/cpp/_std/Sys.hx",76);
		HX_STACK_ARG(s,"s");
		HX_STACK_LINE(76)
		::Sys_obj::set_cwd(s);
	}
...
::String Sys_obj::executablePath( ){
	HX_STACK_PUSH("Sys::executablePath","D:\\HaxeToolkit\\haxe/std/cpp/_std/Sys.hx",119);
	HX_STACK_LINE(119)
