...
Void FlxGame_obj::draw( ){
{
		...
		if ((::flixel::FlxG_obj::debugger->visible)){
			HX_STACK_LINE(728)
			::flixel::system::debug::Stats _this = this->debugger->stats;		HX_STACK_VAR(_this,"_this");
			HX_STACK_LINE(728)
			_this->_drawCalls[(_this->_drawCallsMarker)++] = ::flixel::system::layer::TileSheetExt_obj::_DRAWCALLS;
		}
		HX_STACK_LINE(733)
		{
			HX_STACK_LINE(733)
		...
		if ((::flixel::FlxG_obj::debugger->visible)){
			...
			::flixel::system::debug::Stats _this = this->debugger->stats;		HX_STACK_VAR(_this,"_this");
			HX_STACK_LINE(738)
			_this->_draw[(_this->_drawMarker)++] = (::flash::Lib_obj::getTimer() - this->ticks);
		}
	}
return null();
}
...
Void FlxGame_obj::update( ){
{
		...
		if ((::flixel::FlxG_obj::debugger->visible)){
			...
			::flixel::system::debug::Stats _this = this->debugger->stats;		HX_STACK_VAR(_this,"_this");
			HX_STACK_LINE(616)
			_this->_update[(_this->_updateMarker)++] = (::flash::Lib_obj::getTimer() - this->ticks);
		}
	}
return null();
}
...
Void FlxGame_obj::step( ){
{
		...
		if ((this->requestedReset)){
			HX_STACK_LINE(527)
			{
				...
				HX_STACK_LINE(527)
				if ((::Std_obj::is(this->requestedState,hx::ClassOf< ::flixel::FlxSubState >()))){
					HX_STACK_LINE(527)
		...
		if ((::flixel::FlxG_obj::debugger->visible)){
			...
			::flixel::system::debug::Stats _this = this->debugger->stats;		HX_STACK_VAR(_this,"_this");
			HX_STACK_LINE(572)
			_this->_activeObject[(_this->_activeObjectMarker)++] = ::flixel::FlxBasic_obj::_ACTIVECOUNT;
		}
	}
return null();
}
		...
		if ((!(this->_lostFocus))){
			...
			if ((::flixel::FlxG_obj::debugger->visible)){
				HX_STACK_LINE(419)
				{
					...
					::flixel::system::debug::Stats _this = this->debugger->stats;		HX_STACK_VAR(_this,"_this");
					HX_STACK_LINE(419)
					_this->_flash[(_this->_flashMarker)++] = this->elapsedMS;
				}
				HX_STACK_LINE(420)
				{
					HX_STACK_LINE(420)
					::flixel::system::debug::Stats _this = this->debugger->stats;		HX_STACK_VAR(_this,"_this");
					HX_STACK_LINE(420)
					_this->_visibleObject[(_this->_visibleObjectMarker)++] = ::flixel::FlxBasic_obj::_VISIBLECOUNT;
				}
				HX_STACK_LINE(421)
...
Void FlxGame_obj::onResize( ::flash::events::Event E){
{
		...
		HX_STACK_LINE(350)
		{
			...
			HX_STACK_LINE(350)
			if (((_this->bmpLog != null()))){
				HX_STACK_LINE(350)
				_this->bmpLog->updateBounds(_this->_screenBounds);
			}
			HX_STACK_LINE(350)
			_this->_topBar->set_width(::flixel::FlxG_obj::game->get_stage()->get_stageWidth());
			HX_STACK_LINE(350)
...
Void FlxGame_obj::create( ::flash::events::Event FlashEvent){
{
		...
		HX_STACK_LINE(233)
		this->debugger = ::flixel::system::debug::FlxDebugger_obj::__new((::flixel::FlxG_obj::width * ::flixel::FlxCamera_obj::defaultZoom),(::flixel::FlxG_obj::height * ::flixel::FlxCamera_obj::defaultZoom));
		HX_STACK_LINE(234)
