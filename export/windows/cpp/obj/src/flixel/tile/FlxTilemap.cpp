...
HX_STACK_PUSH("FlxTilemap::new","flixel/tile/FlxTilemap.hx",33);
{
	...
	this->cameras = null();
	HX_STACK_LINE(232)
	this->_lastVisualDebug = ::flixel::FlxG_obj::debugger->visualDebug;
	HX_STACK_LINE(235)
...
::flixel::util::FlxRect FlxTilemap_obj::getBounds( ::flixel::util::FlxRect Bounds){
	...
	struct _Function_1_1{
		inline static ::flixel::util::FlxRect Block( ::flixel::util::FlxRect &Bounds,::flixel::tile::FlxTilemap_obj *__this){
...
{
		HX_STACK_PUSH("FlxTilemap::drawDebugOnCamera","flixel/tile/FlxTilemap.hx",739);
		HX_STACK_THIS(this);
		HX_STACK_ARG(Camera,"Camera");
		HX_STACK_LINE(740)
...
{
		HX_STACK_PUSH("FlxTilemap::update","flixel/tile/FlxTilemap.hx",560);
		HX_STACK_THIS(this);
		HX_STACK_LINE(561)
		if (((this->_lastVisualDebug != ::flixel::FlxG_obj::debugger->visualDebug))){
			HX_STACK_LINE(563)
			this->_lastVisualDebug = ::flixel::FlxG_obj::debugger->visualDebug;
			HX_STACK_LINE(564)
			this->setDirty(null());
...
{
	imgAuto= HX_CSTRING("flixel/img/tile/autotiles.png");
	imgAutoAlt= HX_CSTRING("flixel/img/tile/autotiles_alt.png");
	OFF= (int)0;
	AUTO= (int)1;
	ALT= (int)2;
}
