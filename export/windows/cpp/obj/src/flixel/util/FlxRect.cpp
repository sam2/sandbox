...
::flixel::util::FlxRect FlxRect_obj::_union( ::flixel::util::FlxRect Rect){
	...
	struct _Function_1_1{
		inline static ::flixel::util::FlxRect Block( ::flixel::util::FlxRect_obj *__this,Float &minY,Float &minX,Float &maxY,Float &maxX){
	...
	HX_STACK_LINE(191)
	return _Function_1_1::Block(this,minY,minX,maxY,maxX);
}
