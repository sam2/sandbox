...
HX_STACK_PUSH("Xml::__init__","D:\\HaxeToolkit\\haxe/std/cpp/_std/Xml.hx",403);
{
	HX_STACK_LINE(404)
...
Dynamic Xml_obj::elements( ){
	HX_STACK_PUSH("Xml::elements","D:\\HaxeToolkit\\haxe/std/cpp/_std/Xml.hx",238);
	HX_STACK_THIS(this);
	HX_STACK_LINE(239)
	...
	struct _Function_1_1{
		inline static Dynamic Block( Array< ::Dynamic > &children){
			HX_STACK_PUSH("*::closure","D:\\HaxeToolkit\\haxe/std/cpp/_std/Xml.hx",242);
			{
				...
				bool run(){
					HX_STACK_PUSH("*::_Function_2_1","D:\\HaxeToolkit\\haxe/std/cpp/_std/Xml.hx",244);
				...
				::Xml run(){
					HX_STACK_PUSH("*::_Function_2_2","D:\\HaxeToolkit\\haxe/std/cpp/_std/Xml.hx",255);
					HX_STACK_THIS(__this.mPtr);
					{
						HX_STACK_LINE(256)
						int k = __this->__Field(HX_CSTRING("cur"),true);		HX_STACK_VAR(k,"k");
...
::String Xml_obj::get( ::String att){
	HX_STACK_PUSH("Xml::get","D:\\HaxeToolkit\\haxe/std/cpp/_std/Xml.hx",197);
	HX_STACK_THIS(this);
...
::String Xml_obj::get_nodeName( ){
	HX_STACK_PUSH("Xml::get_nodeName","D:\\HaxeToolkit\\haxe/std/cpp/_std/Xml.hx",168);
	HX_STACK_THIS(this);
	HX_STACK_LINE(169)
	if (((this->nodeType != ::Xml_obj::Element))){
		HX_STACK_LINE(170)
