...
{
HX_STACK_PUSH("StringBuf::new","D:\\HaxeToolkit\\haxe/std/cpp/_std/StringBuf.hx",27);
{
	HX_STACK_LINE(27)
...
{
		HX_STACK_PUSH("StringBuf::add","D:\\HaxeToolkit\\haxe/std/cpp/_std/StringBuf.hx",31);
		HX_STACK_THIS(this);
		HX_STACK_ARG(x,"x");
		HX_STACK_LINE(31)
		this->b->push(x);
