...
::String Input_obj::readLine( ){
	HX_STACK_PUSH("Input::readLine","D:\\HaxeToolkit\\haxe/std/haxe/io/Input.hx",127);
	HX_STACK_THIS(this);
	HX_STACK_LINE(128)
...
{
		HX_STACK_PUSH("Input::close","D:\\HaxeToolkit\\haxe/std/haxe/io/Input.hx",67);
		HX_STACK_THIS(this);
	}
return null();
}
...
int Input_obj::readByte( ){
	HX_STACK_PUSH("Input::readByte","D:\\HaxeToolkit\\haxe/std/haxe/io/Input.hx",37);
	HX_STACK_THIS(this);
	HX_STACK_LINE(39)
