...
::String StringTools_obj::urlEncode( ::String s){
	HX_STACK_PUSH("StringTools::urlEncode","D:\\HaxeToolkit\\haxe/std/StringTools.hx",37);
	HX_STACK_ARG(s,"s");
	HX_STACK_LINE(37)
...
::String StringTools_obj::urlDecode( ::String s){
	HX_STACK_PUSH("StringTools::urlDecode","D:\\HaxeToolkit\\haxe/std/StringTools.hx",62);
	HX_STACK_ARG(s,"s");
	HX_STACK_LINE(62)
...
bool StringTools_obj::startsWith( ::String s,::String start){
	HX_STACK_PUSH("StringTools::startsWith","D:\\HaxeToolkit\\haxe/std/StringTools.hx",124);
	HX_STACK_ARG(s,"s");
...
bool StringTools_obj::endsWith( ::String s,::String end){
	HX_STACK_PUSH("StringTools::endsWith","D:\\HaxeToolkit\\haxe/std/StringTools.hx",141);
	HX_STACK_ARG(s,"s");
...
bool StringTools_obj::isSpace( ::String s,int pos){
	HX_STACK_PUSH("StringTools::isSpace","D:\\HaxeToolkit\\haxe/std/StringTools.hx",162);
	HX_STACK_ARG(s,"s");
...
::String StringTools_obj::rtrim( ::String s){
	HX_STACK_PUSH("StringTools::rtrim","D:\\HaxeToolkit\\haxe/std/StringTools.hx",201);
	HX_STACK_ARG(s,"s");
	HX_STACK_LINE(205)
...
::String StringTools_obj::replace( ::String s,::String sub,::String by){
	HX_STACK_PUSH("StringTools::replace","D:\\HaxeToolkit\\haxe/std/StringTools.hx",288);
	HX_STACK_ARG(s,"s");
